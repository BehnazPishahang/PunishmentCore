...
namespace Anu.PunishmentOrg.ServiceContract
{
    ...
    public class PBillStoreProduct
    {
        ...
        {
            this.ThePBillStoreDiscoveryRowsList = new List<Anu.PunishmentOrg.ServiceContract.PBillStoreDiscoveryRows>(); 
            this.ThePBillStoreProductDiscoveryList = new List<Anu.PunishmentOrg.ServiceContract.PBillStoreProductDiscovery>(); 
            ...
            public List<Anu.PunishmentOrg.ServiceContract.PBillStoreDiscoveryRows> ThePBillStoreDiscoveryRowsList { get; set ;} 
            
            
            [System.ComponentModel.DataAnnotations.Required]
            [System.ComponentModel.DisplayName("کالا/ارز هاي قبض/رسيد صادر شده بر اساس کلا/ارز هاي صورتجلسه کشف در سرويس")]
            public List<Anu.PunishmentOrg.ServiceContract.PBillStoreProductDiscovery> ThePBillStoreProductDiscoveryList { get; set ;} 
