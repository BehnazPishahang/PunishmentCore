...
namespace Utility
{
    public static class ServiceResultUtilities
    {
        ...
        {
            return new Result { Code = type.ToString(), Message = Resources.PunishmentOrg.Common.ResultType.ResourceManager.GetString(type.ToString()) };
        }
        ...
        {
            return new Result { Code = type.ToString(), Message = string.Format(Resources.PunishmentOrg.Common.ResultType.ResourceManager.GetString(type.ToString()), args) };
        }
