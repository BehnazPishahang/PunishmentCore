...
namespace Rad.BaseInfo.FrontEndSecurity
{
    public abstract class GFESCartableBase : BaseInfoEntity<string>
    {
		...
		[Column("STATE")]
		public virtual Rad.CMS.Enumerations.WorkFlowActivityInstanceState? State { get; set; }

		[ForeignKey("ACCESSUSERID")]
		public virtual Rad.BaseInfo.FrontEndSecurity.GFESUser? TheAccessUser { get; set; }

		[ForeignKey("ACTIVITYID")]
		public virtual Rad.BaseInfo.Security.Role.BaseRole? TheActivity { get; set; }

		[ForeignKey("CREATORUSERID")]
		public virtual Rad.BaseInfo.FrontEndSecurity.GFESUser? TheCreatorUser { get; set; }
		...
		public virtual Rad.BaseInfo.FrontEndSecurity.GFESUser? ThePerformerUser { get; set; }
		...
		public virtual Rad.BaseInfo.SystemObject.SystemObject? TheRelatedSysObjectCase { get; set; }

		[ForeignKey("RELATEDSYSOBJECTDOCID")]
		public virtual Rad.BaseInfo.SystemObject.SystemObject? TheRelatedSysObjectDoc { get; set; }
