...
{
    public abstract class GCountryDivisionKindBase : BaseInfoEntity<string>
    {
    ...
    [Table("GCOUNTRYDIVISIONKIND")]
    public partial class GCountryDivisionKind : GCountryDivisionKindBase { }
