...
namespace Rad.BaseInfo.SystemConfiguration
{
    public abstract class CaseServerBase : BaseInfoEntity<string>
    {
		...
		public virtual Rad.CMS.Enumerations.YesNo? IsCurrentServer { get; set; }

		[Column("ISRELTOCENTRAL")]
		public virtual Rad.CMS.Enumerations.YesNo? IsRelToCentral { get; set; }

		[Column("MANAGERSERVERIP")]
		public virtual string? ManagerServerIP { get; set; }

		[Column("SERVERTYPE")]
		public virtual Rad.CMS.Enumerations.ServerType? ServerType { get; set; }
