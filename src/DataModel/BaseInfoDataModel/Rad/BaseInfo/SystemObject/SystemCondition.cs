...
namespace Rad.BaseInfo.SystemObject
{
    public abstract class SystemConditionBase : BaseInfoEntity<string>
    {
		...
		public virtual List<Rad.BaseInfo.SystemObject.SystemConditionTerm>? TheSystemConditionTermList { get; set; }

		[ForeignKey("SYSTEMCONDITIONID")]
		public virtual List<Rad.BaseInfo.SystemObject.SystemConditionVariable>? TheSystemConditionVariableList { get; set; }
