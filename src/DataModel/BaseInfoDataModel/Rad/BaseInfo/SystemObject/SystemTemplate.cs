...
namespace Rad.BaseInfo.SystemObject
{
    public abstract class SystemTemplateBase : BaseInfoEntity<string>
    {
		...
		public virtual Rad.CMS.Enumerations.MainMinorTemplate? MainMinorTemplate { get; set; }
		...
		public virtual List<Rad.BaseInfo.SystemObject.SystemTemplateCondition>? TheSystemTemplateConditionList { get; set; }

		[ForeignKey("TEMPLATEHAVELOOPID")]
		public virtual List<Rad.BaseInfo.SystemObject.SystemTemplateLoop>? TheSystemTemplateLoopList { get; set; }

		[ForeignKey("SYSTEMTEMPLATEID")]
		public virtual List<Rad.BaseInfo.SystemObject.SystemTemplateObject>? TheSystemTemplateObjectList { get; set; }

		[ForeignKey("SYSTEMTEMPLATEID")]
		public virtual List<Rad.BaseInfo.SystemObject.SystemTemplateVariable>? TheSystemTemplateVariableList { get; set; }

		[ForeignKey("TEMPLATEUSAGETYPEID")]
		public virtual Rad.BaseInfo.SystemObject.TemplateUsageType? TheTemplateUsageType { get; set; }
