...
{
    public abstract class CaseFlowTypeBase : BaseInfoEntity<string>
    {
		...
		[Column("NEEDTONOTIFY")]
		public virtual Rad.CMS.Enumerations.YesNo? NeedToNotify { get; set; }
    ...
    [Table("CASEFLOWTYPE")]
    public partial class CaseFlowType : CaseFlowTypeBase { }
