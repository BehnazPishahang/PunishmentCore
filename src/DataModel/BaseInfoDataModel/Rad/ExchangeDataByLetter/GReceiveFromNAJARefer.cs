...
{
    public abstract class GReceiveFromNAJAReferBase : BaseInfoEntity<string>
    {
    ...
    [Table("GRECEIVEFROMNAJAREFER")]
    public partial class GReceiveFromNAJARefer : GReceiveFromNAJAReferBase { }
