...
namespace Rad.Messaging
{
    public abstract class GMessageBase : BaseInfoEntity<string>
    {
		...
		[Column("SECURITYTYPE")]
		public virtual Rad.CMS.Enumerations.MessageSecurityType? SecurityType { get; set; }

		[Column("STATE")]
		public virtual Rad.CMS.Enumerations.MessageState? State { get; set; }

		[InverseProperty("TheGMessage")]
		public virtual List<Rad.Messaging.GMessageReciever>? TheGMessageRecieverList { get; set; }
		...
		[Column("URGENTTYPE")]
		public virtual Rad.CMS.Enumerations.MessageForceType? UrgentType { get; set; }
