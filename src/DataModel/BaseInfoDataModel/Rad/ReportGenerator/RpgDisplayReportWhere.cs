...
{
    public abstract class RpgDisplayReportWhereBase : BaseInfoEntity<string>
    {
    ...
    [Table("RPGDISPLAYREPORTWHERE")]
    public partial class RpgDisplayReportWhere : RpgDisplayReportWhereBase { }
