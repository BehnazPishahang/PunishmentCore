...
namespace Rad.Trm.EMail
{
    public abstract class TrmEMailBase : BaseInfoEntity<string>
    {
		...
		[Column("EMAILSTATUS")]
		public virtual Rad.CMS.Enumerations.CMSEMailStatus? EMailStatus { get; set; }
		...
		public virtual List<Rad.Trm.EMail.TrmEMailNotSend>? TheTrmEMailNotSendList { get; set; }
