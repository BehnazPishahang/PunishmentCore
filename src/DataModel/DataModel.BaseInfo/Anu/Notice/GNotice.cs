...
namespace DataModel.BaseInfo.Anu.Notice
{
    public abstract class GNoticeBase : BaseInfoEntity<string>
    {
		...
		public virtual Anu.Enumerations.ConfirmerNoticeState? ConfirmerNoticeState { get; set; }
		...
		[Column("ISEMAIL")]
		public virtual Anu.Enumerations.YesNo? IsEMail { get; set; }

		[Column("ISPRINTED")]
		public virtual Anu.Enumerations.YesNo? IsPrinted { get; set; }

		[Column("ISRESPITEREQUESTED")]
		public virtual Anu.Enumerations.YesNo? IsRespiteRequested { get; set; }

		[Column("ISSMS")]
		public virtual Anu.Enumerations.YesNo? IsSMS { get; set; }
		...
		public virtual Anu.Enumerations.SequenceNum? PrintingMultiplicity { get; set; }
		...
		public virtual Anu.BaseInfo.SystemObject.SystemObject? TheCaseNotice { get; set; }

		[ForeignKey("CONFIRMERNOTICEUSERID")]
		public virtual Anu.BaseInfo.Security.CMSUser.CMSUser? TheConfirmerNoticeUser { get; set; }
		...
		public virtual List<Anu.Notice.GNoticeAttachment>? TheGNoticeAttachmentList { get; set; }

		[ForeignKey("GNOTICEID")]
		public virtual List<Anu.Notice.GNoticeDoc>? TheGNoticeDocList { get; set; }

		[InverseProperty("TheGNotice")]
		public virtual List<Anu.Notice.GNoticeTranscript>? TheGNoticeTranscriptList { get; set; }
		...
		public virtual Anu.BaseInfo.Security.CMSUser.CMSUser? TheRegisteredUser { get; set; }

		[ForeignKey("RESULTREGUSERID")]
		public virtual Anu.BaseInfo.Security.CMSUser.CMSUser? TheResultRegUser { get; set; }

		[ForeignKey("SELFNOTIFICATIONID")]
		public virtual Anu.BaseInfo.SystemObject.SystemObject? TheSelfNotification { get; set; }

		[Column("TYPISTACCESSIBLE")]
		public virtual Anu.Enumerations.HaveNoHave? TypistAccessible { get; set; }
