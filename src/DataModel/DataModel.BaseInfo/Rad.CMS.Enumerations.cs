	...
	namespace Rad.CMS.Enumerations
	{
		...
		[Description("EnmCPDFSignType")]
		public enum CPDFSignType
		{
			[Description("امضا نشده")]
			NotSigned = 1,			
			[Description("امضا شده")]
			Signed = 2,			
			[Description("امضا شده با مهر سازماني")]
			SignedWithStamp = 3,			
			[Description("")]
			None = 0
		}
