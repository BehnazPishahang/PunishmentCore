...
{
    public abstract class PBJudgeSubjectTypeBase : PunishmentOrgEntity<string>
    {
    ...
    [Table("PBJUDGESUBJECTTYPE")]
    public partial class PBJudgeSubjectType : PBJudgeSubjectTypeBase { }
