...
namespace Anu.PunishmentOrg.Case
{
    public abstract class PInterimVisibleCaseBase : PunishmentOrgEntity<string>
    {
		...
		public virtual Anu.BaseInfo.OrganizationChart.Unit? TheInterimVisibleUnit { get; set; }

		[ForeignKey("OWNERCASEUNITID")]
		public virtual Anu.BaseInfo.OrganizationChart.Unit? TheOwnerCaseUnit { get; set; }
