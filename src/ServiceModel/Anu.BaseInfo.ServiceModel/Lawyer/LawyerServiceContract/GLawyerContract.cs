...
namespace Anu.BaseInfo.ServiceModel.Lawyer.LawyerServiceContract
{
    ...
    public class GLawyerContract
    {
        ...
        public Anu.BaseInfo.Enumerations.YesNo? IsDeleted { get; set; }
        ...
        public Anu.BaseInfo.Enumerations.LawyerTypeLicense? LawyerTypeLicense { get; set; }
        ...
        public Anu.BaseInfo.Enumerations.MarriageState? MariageState { get; set; }
