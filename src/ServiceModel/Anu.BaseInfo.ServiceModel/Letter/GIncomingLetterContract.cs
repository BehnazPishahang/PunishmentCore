namespace Anu.BaseInfo.ServiceModel.Letter
{
    ...
    public class GIncomingLetterContract
    {
        ...
        public Enumerations.IncommingLetterSenderType? SenderType { get; set; }



        [System.ComponentModel.DataAnnotations.Required]
        [System.ComponentModel.DisplayName("ارسال از طريق اينترنت")]
        public Enumerations.YesNo? SendViaInternet { get; set; }



        [System.ComponentModel.DataAnnotations.Required]
        [System.ComponentModel.DisplayName("وضعيت")]
        public Enumerations.IncomingLetterState? State { get; set; }
