...
{
    [System.ComponentModel.DisplayName("پرونده يا مدرک هاي مربوطه نامه صادره در سرویس")]
    public class GOutgoingLetterCaseContract
    {
        public GOutgoingLetterCaseContract()
        {
        }
