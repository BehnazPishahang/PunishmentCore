...
{
    [System.ComponentModel.DisplayName("گزارش بازرسي در سرویس")]
    public class PInspectionReportContract
    {
        public PInspectionReportContract()
        {
        }
        ...
        public string? InspectionReportNo { get; set; }
            ...
            [System.ComponentModel.DisplayName("نوع گزارش بازرسي")]
        public Anu.PunishmentOrg.Enumerations.InspectionReportType? InspectionReportType { get; set; }
        ...
        public string? ReportBaseOther { get; set; }
            ...
            [System.ComponentModel.DisplayName("توضيح در مورد علت برگشت گزارش به سازمان ارسال کننده")]
        ...
        public Anu.BaseInfo.Enumerations.YesNo? SaveType { get; set; }
                ...
                [System.ComponentModel.DataAnnotations.Required]
            [System.ComponentModel.DisplayName("مرتبه ارسال گزارش")]
